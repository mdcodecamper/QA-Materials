 ...
 */
public class TEST003_SaveTemplate_DeleteTemplate extends AbstractStartWebDriver {
    ...
    public void taskDeleteTemplate_HHRefuse_CleaningBaskets() throws InterruptedException, IOException {

        extentTest.assignCategory( "Smoke", "Delete template" );
        System.out.println( "**************************************************************************************" );
        System.out.println( "Scenario 1 - Ref#MINERVA-4567 Save a template for an active shift with collection and cleaning subcategories then Delete the templete" );
        System.out.println( "**************************************************************************************" );
        logTestInfo( wDriver, "Scenario 1 - Ref#MINERVA-4567 Save a template for an active shift with collection and cleaning subcategories then Delete the templete" );
        ...
        //line below will perform delete template action
        taskTemplateActions().deleteTemplate(templateName, "Standard");
        //line below will verify template doesn't exist in Load Template Modal Window after delete
        taskModeUtilities().verifyTemplateExist( false, templateName);
