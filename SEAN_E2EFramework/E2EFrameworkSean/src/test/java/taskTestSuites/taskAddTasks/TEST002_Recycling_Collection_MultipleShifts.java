 ...
 */
public class TEST002_Recycling_Collection_MultipleShifts extends AbstractStartWebDriver {
    ...
    public void taskAssignEquipment_Minerva4606_Assign() throws InterruptedException, IOException {
       ...
       //line below will close person menu
        ...
        //line below will add tasks from Snow Salt Spreader for shift 3
        taskAddTaskActions().addTasks( garage, shift3, "SanitationWorker", "Snow", "Salt Spreading", "2", 3 );
