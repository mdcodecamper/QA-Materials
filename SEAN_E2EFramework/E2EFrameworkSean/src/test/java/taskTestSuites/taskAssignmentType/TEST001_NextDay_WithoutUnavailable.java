 ...
 */
public class TEST001_NextDay_WithoutUnavailable extends AbstractStartWebDriver {
    ...
    public void taskAssignmentType_NextDay_WithoutUnavailable() throws InterruptedException, IOException {
        location = setPersonLocationForTest("Available", "SW", 2);
        extentTest.assignCategory( "Smoke", "Assign Person as Next Day without Unavailability" );
        System.out.println( "**************************************************************************************" );
        System.out.println( "Scenario 1 - Assign Person as Next Day without Unavailability" );
        System.out.println( "**************************************************************************************" );
        logTestInfo( wDriver, "Scenario 1 - Assign Person as Next Day without Unavailability" );
