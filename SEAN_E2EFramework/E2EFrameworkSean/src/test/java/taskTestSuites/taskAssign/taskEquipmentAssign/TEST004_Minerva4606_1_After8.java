 ...
 */
public class TEST004_Minerva4606_1_After8 extends AbstractStartWebDriver {
    ...
    public void taskAssignEquipment_Minerva4606_Assign_After8() throws InterruptedException, IOException {
        //setEquipmentLocationForTest("Available","RearLoaders", 16);
        ...
        System.out.println("**************************************************************************************");
        System.out.println("Scenario 1 - Assign rear loaders equipment to a collection and RECYCLE for a over night shift");
        System.out.println("**************************************************************************************");
        logTestInfo(wDriver, "Scenario 1 - Assign rear loaders equipment to a collection and RECYCLE for a over night shift");
       ...
       /* //line below will add a shift
        ...
        String equipmentId2 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId2, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        ...
        String equipmentId3 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId3, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Pending", "PendingLoad", null, equipmentId3, "true");
        //line below will getEquipment 2 from a category
        String equipmentId4 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId4, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        ...
        String equipmentId5 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line will verify equipment added to relay collection
        equipmentUpdateLoadActions().updateLoad(equipmentId5,"Relay","01",null,null);
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will getEquipment 2 from a category
        String equipmentId6 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line will verify equipment added to Rollover collection
        equipmentUpdateLoadActions().updateLoad(equipmentId6,"Rollover","01",null,null);
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will get equipment from category for snow
        String equipmentSnow = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        taskAssignActions().assignEquipmentToTask(garage, equipmentSnow, shift3, "SNOW", "SALT_SPREADING", null, 0);
        //line below will verify equipment present in Snow Salt Spreader subcategory on task 1
        taskModeUtilities().verifyCardPresentOnTask(true,garage, "Equipment",equipmentSnow, shift3, "SNOW", "SALT_SPREADING", 0);
        //line below will check if equipment is not present not in Rear Loaders after assigning equipment to snow task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentSnow, "false");
        //line below will check if equipment is not present in pending load after assigning equipment to snow task
        equipmentPanelUtilities().verifyEquipmentPresent("Pending", "PendingLoad", null, equipmentSnow, "false");

        //line below will getEquipment for shift 4 from a category
        String equipmentId7 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId7, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Pending", "PendingLoad", null, equipmentId7, "true");
        //line below will getEquipment 2 from a category
        String equipmentId8 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId8, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        ...
        String equipmentId9 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId9, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Pending", "PendingLoad", null, equipmentId9, "true");
        //line below will getEquipment 2 from a category
        String equipmentId10 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId10, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        ...
        String equipmentId11 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId11, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Pending", "PendingLoad", null, equipmentId11, "true");
        //line below will getEquipment 2 from a category
        String equipmentId12 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId12, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        ...
        String equipmentId13 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId13, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Pending", "PendingLoad", null, equipmentId13, "true");
        //line below will getEquipment 2 from a category
        String equipmentId14 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId14, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        ...
        String equipmentId15 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId15, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Pending", "PendingLoad", null, equipmentId15, "true");
        //line below will getEquipment 2 from a category
        String equipmentId16 = equipmentPanelUtilities().getEquipmentFromCategory("Bin", "Available", "RearLoaders");
        //line below will go to Edit mode
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        ...
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
        equipmentPanelUtilities().verifyEquipmentPresent("Available", "RearLoaders", null, equipmentId16, "false");
        //line below will check if equipment is present in pending load after assigning equipment to task
