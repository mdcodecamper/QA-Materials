 ...
 */
public class TEST009_Minerva4606_EquipmentAssign_DualGarage extends AbstractStartWebDriver {
    ...
    public void taskAssignEquipment_Minerva4606_Assign_DualGarage() throws InterruptedException, IOException {
       ...
       /* //line below will add a shift
        ...
        taskModeUtilities().shiftStatus( "QE11W", shift1, "Active" );

        //line below will make shift 2 active
        taskModeUtilities().shiftStatus( "QE11W", shift2, "Active" );

        //line below will make shift 5 active
        taskModeUtilities().shiftStatus( "QE11W", shift5, "Active" );

        //line below will make shift 6 active
        taskModeUtilities().shiftStatus( "QE11W", shift6, "Active" );

        //line below will make shift 7 active
        taskModeUtilities().shiftStatus( "QE11W", shift7, "Active" );

        //line below will make shift 8 active
        taskModeUtilities().shiftStatus( "QE11W", shift8, "Active" );
        ...
        taskAssignActions().assignEquipmentToTask("QE11W", equipmentId1, shift1, "COLLECT", "RELAYS", null, 0);
        //line below will verify equipment present in Relays subcategory on task 1
        taskModeUtilities().verifyCardPresentOnTask(true,"QE11W", "Equipment",equipmentId1, shift1, "COLLECT", "RELAYS", 0);
        ...
        taskModeUtilities().clickonEditModeButton();
        //line below will assign equipment to task on Relays
        taskAssignActions().assignEquipmentToTask("QE11W", equipmentId2, shift1, "RECYCLE", "RELAYS_RCY", null, 0);
        //line below will verify equipment present in Relays RECYCLE subcategory on task 1
        taskModeUtilities().verifyCardPresentOnTask(true,"QE11W", "Equipment",equipmentId2, shift1, "RECYCLE", "RELAYS_RCY", 0);
        //line below will check if equipment is not present not in dual bins after assigning equipment to task
