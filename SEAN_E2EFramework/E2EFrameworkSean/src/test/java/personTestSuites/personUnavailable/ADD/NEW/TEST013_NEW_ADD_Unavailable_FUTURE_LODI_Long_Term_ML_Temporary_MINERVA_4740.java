 ...
 */
public class TEST013_NEW_ADD_Unavailable_FUTURE_LODI_Long_Term_ML_Temporary_MINERVA_4740 extends AbstractStartWebDriver {
    //Test Data
    ...
    public static String expEffectiveDate = Utilities.getDesiredDateInFormat(1, "M/d/yyyy");
    ...
    public static String endDate = Utilities.getDesiredDateInFormat(1, "MM/dd/yyyy");
    public static String expectedEndDate = Utilities.getDesiredDateInFormat(1, "M/d/yyyy");
    ...
    @Test(priority = 1, description = "NEW_ADD_Unavailable_FUTURE_LODI_Long_Term_ML_Temporary_MINERVA_4740")
    public void NEW_ADD_Unavailable_FUTURE_LODI_Long_Term_ML_Temporary_MINERVA_4740() throws InterruptedException, IOException {
        ...
        String[] expectedAddDetails = {unavailableCode, "ADD", "Future", expEffectiveDate, effectiveHour + ":" + effectiveMinute, remarks};
        ...
        try {
            ...
            Assert.assertFalse(checkCardPresence(swCardName, "Unavailable", "LODI"), "Card Not In LODI");
