 ...
 */
public class TEST015_NEW_ADD_Unavailable_PAST_LODI_Long_Term_ML_Temporary_MINERVA_4738 extends AbstractStartWebDriver {
    //Test Data
    ...
    public static String endDate = Utilities.getDesiredDateInFormat(-15, "MM/dd/yyyy");
    public static String expectedEndDate = Utilities.getDesiredDateInFormat(-15, "M/d/yyyy");
    ...
    public void ADD_Unavailable_PAST_LODI_Long_Term_ML_Temporary_MINERVA_4738() throws InterruptedException, IOException {
        logTestInfo(wDriver, "MINERVA_4738: Single Day Lodi ML Temporary Starting and Ending in the Past");
