...
import static equipment.abstractBase.EquipmentBasePage.equipmentAcceptDetachActions;
import static equipment.abstractBase.EquipmentBasePage.equipmentDetachActions;
...
import static task.abstractBase.TaskBasePage.taskDetailActions;

/**
 * Created by skashem on 11/28/2016.
 */
public class TEST003_Minerva3326 extends AbstractStartWebDriver {
    ...
    @Test
    public void equipmentAcceptDetach_MINERVA3326() throws InterruptedException, IOException {
        setEquipmentLocationForTest("Available","RearLoad", 1);
        ...
        System.out.println( "**************************************************************************************" );
        logTestInfo( wDriver, "Minerva-3326 - Can't Accept Equipment That Was Previously Assigned For That Board Date" );
