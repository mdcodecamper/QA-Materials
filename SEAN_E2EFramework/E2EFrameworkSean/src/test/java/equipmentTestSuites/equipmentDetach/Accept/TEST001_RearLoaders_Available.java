...
public class TEST001_RearLoaders_Available extends AbstractStartWebDriver {
    ...
    public void equipmentAcceptDetach_RearLoaders_Available() throws InterruptedException, IOException {
        ...
        System.out.println("**************************************************************************************");
        System.out.println("Scenario 1 - Accept a single bin rear loaders equipment on receiving location");
        System.out.println("**************************************************************************************");
        logTestInfo(wDriver, "Scenario 1 - Accept a single bin rear loaders equipment on receiving location");
        ...
        int rearLoadersCountBefore = getAnyCategoryCardsCount("Equipment","Available", "RearLoaders", null);
