...
public class TEST002_DualBins_Available extends AbstractStartWebDriver {
    ...
    public void equipmentCancelDetach_DualBins_Available() throws InterruptedException, IOException {
        ...
        System.out.println( "**************************************************************************************" );
        System.out.println( "Scenario 1 - cancel a dual bins equipment" );
        System.out.println( "**************************************************************************************" );
        extentTest.log( LogStatus.INFO, "Scenario 1 - cancel a dual bins equipment" );
        ...
        //line below will return pendting detach category count before cancel detach on receiving location
