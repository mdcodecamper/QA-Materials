 ...
 */
public class TEST006_MinervaSno27 extends AbstractStartWebDriver{
    ...
    public void equipmentDown_RearLoaders_Available_3Codes() throws InterruptedException, IOException {
        ...
        System.out.println("**************************************************************************************");
        System.out.println("Scenario 6 - ability to Down a equipment on previous day from Available Rear Loaders category with 3 down codes");
        System.out.println("**************************************************************************************");
        extentTest.log( LogStatus.INFO, "Scenario 6 - ability to Down a equipment on previous day from Available Rear Loaders category with 3 down codes");
        ...
        equipmentHistoryUtilities().getEquipmentUpDownHisotry(equipmentId,"1","3","Set Down",exDownDate,downHour3 + ":"  + downMinute3,"DN59-f",serviceLocation3,reporter3,mechanic3,remarks3);


        //line below will open current board
        loginPage().goToBoardLocationByDate(url, location + "/", boardDate);
        //line below will verify equipment is present in down category
        equipmentPanelUtilities().verifyEquipmentPresent("Down",null, null, equipmentId, "true");
        //line below will check if equipment color is as expected in down category
        equipmentColorUtilities().verifyEquipmentCardColor(equipmentId, "Equipment","navyBlue");
        //line below will check if equipment text color is as expected in down category
        equipmentColorUtilities().verifyEquipmentTextColor(equipmentId,"black");
        //line below will check equipment rear loader bin type is present in down category after down
        equipmentPanelUtilities().equipmentBinType(equipmentId,"E",null);
