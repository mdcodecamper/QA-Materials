...
public class TEST001_RearLoaders_Available extends AbstractStartWebDriver {
    ...
    public void equipmentSnowUpdate_RearLoaders_Available() throws InterruptedException, IOException {
        ...
        System.out.println( "**************************************************************************************" );
        System.out.println( "Scenario 1 - Perform Snow Update on single bin Rear Loaders equipment" );
        System.out.println( "**************************************************************************************" );
        logTestInfo(wDriver, "Scenario 1 - Perform Snow Update on single bin Rear Loaders equipment" );
