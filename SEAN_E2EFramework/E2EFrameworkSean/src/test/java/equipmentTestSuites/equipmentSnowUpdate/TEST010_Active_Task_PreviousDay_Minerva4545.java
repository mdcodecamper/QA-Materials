 ...
 */
public class TEST010_Active_Task_PreviousDay_Minerva4545 extends AbstractStartWebDriver {
    ...
    public void equipmentSnowUpdate_Minerva4545_PreviousDay() throws InterruptedException, IOException {
        ...
        System.out.println("**************************************************************************************");
        logTestInfo(wDriver, "Peform Snow Update on a equipment on previous day with active tasks");
        System.out.println("**************************************************************************************");
        ...
        //line below will check if equipment is present in Pending Load after snow update
        equipmentPanelUtilities().verifyEquipmentPresent("Pending","PendingLoad", null,equipmentId, "true");
        //line below will check if equipment color is as expected after snow update in Task
        equipmentColorUtilities().verifyEquipmentCardColor(equipmentId, "Task","orange");
        ...
        //line below will verify equipment is in Pending Load category after snow update on previous day board
        equipmentPanelUtilities().verifyEquipmentPresent("Pending", "PendingLoad", null, equipmentId, "true");
